  ...
  return (
    <div style={{ minHeight: "100vh", background: "#F8F9FC", fontFamily: "system-ui, sans-serif", padding: "40px 20px" }}>
      <div style={{ maxWidth: 700, margin: "0 auto", background: "#fff", borderRadius: 24, padding: 40, boxShadow: "0 1px 3px rgba(0,0,0,.08)" }}>
        <div style={{ width: 64, height: 64, borderRadius: 16, background: "#A7C7E420", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: 20 }}>
          <span style={{ fontSize: 28 }}>💻</span>
        </div>
        <h1 style={{ fontSize: 24, fontWeight: 700, color: "#1F2430", margin: "0 0 4px" }}>Google Summer of Code</h1>
        <p style={{ fontSize: 14, color: "#4a90c0", fontWeight: 600, margin: "0 0 16px" }}>Google LLC</p>
        <div style={{ display: "flex", gap: 8, marginBottom: 20 }}>
          <span style={{ background: "#E4568B10", color: "#E4568B", padding: "4px 12px", borderRadius: 20, fontSize: 12, fontWeight: 600 }}>Fellowship</span>
        ...
        <p style={{ fontSize: 15, color: "#5E6677", lineHeight: 1.7, margin: "0 0 24px" }}>
          GSoC is a global program focused on bringing new contributors into open-source software development. Work with leading open-source organizations on impactful projects mentored by experienced developers.
        </p>
        ...
        <div style={{ display: "flex", gap: 8, flexWrap: "wrap", marginBottom: 24 }}>
          {["React", "Open Source", "Git", "TypeScript", "Node.js"].map((tag) => (
        ...
        <div style={{ background: "linear-gradient(135deg, #4a90c0, #3570a0)", borderRadius: 16, padding: 24, textAlign: "center" }}>
          <p style={{ color: "#fff", fontSize: 15, fontWeight: 600, margin: "0 0 4px" }}>88% Match</p>
          <p style={{ color: "rgba(255,255,255,.7)", fontSize: 13, margin: "0 0 16px" }}>Your open source experience fits</p>
